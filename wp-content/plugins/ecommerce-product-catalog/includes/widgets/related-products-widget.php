...
class related_products_widget extends WP_Widget {
	...
	function __construct() {
		if ( is_plural_form_active() ) {
			...
			$label		 = sprintf( __( 'Related %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'plural' ] ) );
			$sublabel	 = sprintf( __( 'Shows related %s.', 'ecommerce-product-catalog' ), lcfirst( $names[ 'plural' ] ) );
		} else {
