...
function create_product() {
	...
	if ( is_plural_form_active() ) {
		$labels = array(
			...
			'add_new'			 => sprintf( __( 'Add New %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ),
			'add_new_item'		 => sprintf( __( 'Add New %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ),
			'edit_item'			 => sprintf( __( 'Edit %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ),
			'new_item'			 => sprintf( __( 'Add New %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ),
			'view_item'			 => sprintf( __( 'View %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ),
			'search_items'		 => sprintf( __( 'Search %s', 'ecommerce-product-catalog' ), ucfirst( $names[ 'plural' ] ) ),
...
function change_image_box() {
	...
	add_meta_box( 'postimagediv', sprintf( __( '%s Image', 'ecommerce-product-catalog' ), ucfirst( $names[ 'singular' ] ) ), 'post_thumbnail_meta_box', 'al_product', apply_filters( 'product_image_box_column', 'side' ), apply_filters( 'product_image_box_priority', 'high' ) );
}
